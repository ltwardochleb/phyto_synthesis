...
Map_chla_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_chla_n.pdf",Map_chla_n, width = 6.5, height = 7 )

Map_nh4_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= nh4_n_total, shape= Regions, color = nh4_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_nh4_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_nh4_n.pdf",Map_nh4_n, width = 6.5, height = 7 )

Map_no23_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= no23_n_total, shape= Regions, color = no23_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_no23_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_no23_n.pdf",Map_no23_n, width = 6.5, height = 7 )
...
Map_po4_n<-ggplot(data = deltamapr::WW_Delta) +
  ...
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= po4_n_total, shape= Regions, color = po4_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_po4_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_po4_n.pdf",Map_po4_n, width = 6.5, height = 7 )
...
Map_Temp_n<-ggplot(data = deltamapr::WW_Delta) +
  ...
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= Temp_n_total, shape= Regions, color = Temp_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_Temp_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_Temp_n.pdf",Map_Temp_n, width = 6.5, height = 7 )
...
Map_Turbidity_n<-ggplot(data = deltamapr::WW_Delta) +
  ...
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= Turbidity_n_total, shape= Regions, color = Turbidity_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_Turbidity_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_Turbidity_n.pdf",Map_Turbidity_n, width = 6.5, height = 7 )

Map_TSS_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= TSS_n_total, shape= Regions, color = TSS_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_TSS_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_TSS_n.pdf",Map_TSS_n, width = 6.5, height = 7 )

Map_Depth_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= Depth_n_total, shape= Regions, color = Depth_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_Depth_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_Depth_n.pdf",Map_Depth_n, width = 6.5, height = 7 )

Map_DO_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= DO_n_total, shape= Regions, color = DO_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_DO_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_DO_n.pdf",Map_DO_n, width = 6.5, height = 7 )

Map_SpCnd_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= SpCnd_n_total, shape= Regions, color = SpCnd_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_SpCnd_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_SpCnd_n.pdf",Map_SpCnd_n, width = 6.5, height = 7 )

Map_pH_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= pH_n_total, shape= Regions, color = pH_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_pH_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_pH_n.pdf",Map_pH_n, width = 6.5, height = 7 )

Map_DIN_n<-ggplot(data = deltamapr::WW_Delta) +
  geom_sf(aes(),fill="#7fd6d4", color= "#73bfbd") +
  #  geom_sf(data= Delta_regions)+
  geom_point(data = EMP_df_map,
             aes(x = Longitude, y = Latitude, fill= DIN_n_total, shape= Regions, color = DIN_n_total), size = 3) +
  coord_sf(xlim = c(-121.2, -122.15), ylim = c(37.66, 38.48), expand = FALSE)+
  theme_void(base_size = 20)+
  geom_text_repel(data = EMP_df_map, aes(x = Longitude, y = Latitude, label = Site_Abbrev), 
                  fontface = "bold", nudge_x = c(), nudge_y = c(), color= "#AD2A1A",
...
Map_DIN_n
ggsave("/Users/kleathers/Library/CloudStorage/OneDrive-DOI/Shared Documents - BGC Projects (v3)/BGC Proposals and Projects/Active Projects/BOR/Nuts TS Analysis/Phytoplankton_synthesis_project/Figures/Map_DIN_n.pdf",Map_DIN_n, width = 6.5, height = 7 )

### Temporal plots ####
EMP_df <-   left_join(EMP_df, EMP_df_map_region_join)

EMP_df <- EMP_df %>%
  mutate(Site_region = paste(Regions,Site_Abbrev, sep= " ")) %>%
  filter(!is.na(Regions))

plot_chla_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = chla_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_chla_EMP
...
plot_nh4_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = nh4_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_nh4_EMP
...
plot_no23_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = no23_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_no23_EMP
...
plot_po4_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = po4_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_po4_EMP
...
plot_Temp_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = Temp_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_Temp_EMP
...
plot_Turbidity_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = Turbidity_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_Turbidity_EMP
...
plot_TSS_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = TSS_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_TSS_EMP
...
plot_Depth_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = Depth_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_Depth_EMP
...
plot_DO_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = DO_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_DO_EMP
...
plot_SpCnd_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = SpCnd_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_SpCnd_EMP
...
plot_pH_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = pH_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_pH_EMP
...
plot_DIN_EMP<-ggplot(EMP_df, aes(x = year, y = Site_region, fill = DIN_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_DIN_EMP
...
EMP_df_na_omit <-   left_join(EMP_df_na_omit, EMP_df_map_region_join)

EMP_df_na_omit <- EMP_df_na_omit %>%
  mutate(Site_region = paste(Regions,Site_Abbrev, sep= " ")) %>%
  filter(!is.na(Regions))


plot_all_param_EMP<-ggplot(EMP_df_na_omit, aes(x = year, y = Site_region, fill = complete_n)) +
  geom_tile()+
  theme_classic(base_size = 20)+
  scale_fill_distiller(palette = "Spectral")
plot_all_param_EMP
