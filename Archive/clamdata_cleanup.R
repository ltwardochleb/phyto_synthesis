...
usgs = subset(monthly_mean_usgs, select = c(Date, Station, station_name, Corbicula_biomass, Potamocorbula_biomass, Corbicula_GR, Potamocorbula_GR, Corbicula_FR, Potamocorbula_FR, Latitude, Longitude))
...
# Write to csv
write.csv(integrated_df, "Data/integrated_dataset.csv")                           
