...
load("Data/CM data/Daily_BGC_CM_data_2008_2025.RData")
load("Data/CM data/Daily_DWR_CM_data_2008_2025.RData")
load("Data/CM data/Daily_DWR2_CM_data_2008_2025.RData")
load("Data/CM data/Daily_WDL_CM_data_2008_2025.RData")

CM <- rbind(CM_BGC,CM_DWR,CM_DWR2,CM_WDL)
CM <- CM %>% filter(!Station == "MAL")
rm(CM_BGC,CM_DWR,CM_DWR2,CM_WDL)
...
tiff("Figures/Bloom detection/Threshold_5ugL.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/Threshold_10ugL.tiff", units="in", width=16, height=9, res=300)
ggarrange(p1,p2,p3,p4,p5,p6,ncol=2,nrow=3)
dev.off()
...
tiff("Figures/Bloom detection/Quantile_75.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/Perc_Median_90.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/PerYear_90PercentMedian.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/PerYear_75quantile.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/Spline_99PI_1iter.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/Spline_99PI_2iter.tiff", units="in", width=16, height=9, res=300)
ggarrange(p31,p32,p33,p34,p35,p36,ncol=2,nrow=3,common.legend=TRUE)
dev.off()
...
tiff("Figures/Bloom detection/Spline_99PI_3iter.tiff", units="in", width=16, height=9, res=300)
ggarrange(p31,p32,p33,p34,p35,p36,ncol=2,nrow=3,common.legend=TRUE)
dev.off()
...
tiff("Figures/Bloom detection/stdev.tiff", units="in", width=16, height=9, res=300)
...
p31<- p31+ggtitle("Chl > 99% PI of periodic spline - 3 iter")
...
tiff("Figures/Bloom detection/MethodComp_SuisunMarsh.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/MethodComp_SuisunBay.tiff", units="in", width=16, height=9, res=300)
...
p39 <- p39+ggtitle("Chl > 1 stdev of mean")
tiff("Figures/Bloom detection/MethodComp_Confluence.tiff", units="in", width=16, height=9, res=300)
ggarrange(p39,p33,p9,p15,p27,p21,ncol=2,nrow=3,common.legend=TRUE)
dev.off()
...
tiff("Figures/Bloom detection/MethodComp_NorthDelta.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/MethodComp_CentralDelta.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/MethodComp_SouthDelta.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/deltawide_stdev.tiff", units="in", width=16, height=9, res=300)
...
tiff("Figures/Bloom detection/deltawide_Quantile_75.tiff", units="in", width=16, height=9, res=300)
ggarrange(p7,p8,p9,p10,p11,p12,ncol=2,nrow=3,common.legend=TRUE)
dev.off()
...
tiff("Figures/Bloom detection/deltawide_percentile_75.tiff", units="in", width=16, height=9, res=300)
ggarrange(p7,p8,p9,p10,p11,p12,ncol=2,nrow=3,common.legend=TRUE)
dev.off()
